...
public class JXBusyLabelTest extends JFrame implements ActionListener {
  ...
  JXBusyLabel bLabel1;
	...
	public JXBusyLabelTest() {
		...
		/**
		 * Création des boutons et du tableau contenant les couleurs
		 */
	...
	public void coucou(int k){
		System.out.println("coucou");
	}

	/**
	 * Méthode permettant de modifier les couleurs en fonction de l'état de l'afficheur
	 * et de la couleur selectionnée
	 */
